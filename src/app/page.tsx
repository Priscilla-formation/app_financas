...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      {/* Hero — gradiente aplicado inline para garantir renderização */}
      <section
        className="pt-32 pb-28 px-4 sm:px-6 relative overflow-hidden"
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          {/* Headline — branco puro para máximo contraste */}
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight mb-6">
            <span className="text-white drop-shadow-sm">Suas finanças,</span>
            <br />
            <span className="text-emerald-400">sob controle.</span>
          </h1>

          {/* Subheadline — slate-200 (mais claro que slate-300) */}
          <p className="text-lg sm:text-xl text-slate-200 max-w-2xl mx-auto mb-10 leading-relaxed drop-shadow-sm">
            ...
            decisões financeiras mais inteligentes — tudo em um lugar só.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/cadastro">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-emerald-500 hover:bg-emerald-400 text-white font-bold px-8 h-12 text-base rounded-xl gap-2 shadow-lg shadow-black/30"
              >
                Começar grátis
            ...
            <a href="#funcionalidades">
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto border-white/30 text-white hover:bg-white/15 hover:text-white font-semibold px-8 h-12 text-base rounded-xl bg-transparent"
              >
                Ver como funciona
              </Button>
            </a>
      ...
      <section
        id="funcionalidades"
        className="py-24 px-4 sm:px-6 bg-slate-50 dark:bg-slate-900 transition-colors duration-300"
      >
            ...
            {[
              {
                ...
                description:
                  "Veja um resumo completo do seu mês: total de receitas, despesas e saldo disponível com gráfico de pizza por categoria.",
              ...
              <div
                key={f.title}
                className="card-hover bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-7"
              >
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-gradient-to-br from-slate-900 to-emerald-950 rounded-3xl p-12 shadow-2xl">
            ...
            <Link href="/cadastro">
              <Button
                size="lg"
                className="bg-emerald-500 hover:bg-emerald-400 text-white font-bold px-10 h-12 text-base rounded-xl gap-2 shadow-lg shadow-black/30"
              >
                Criar conta grátis
                <ArrowRight className="w-4 h-4" />
              </Button>
      ...
      <footer className="border-t border-slate-100 dark:border-slate-800 py-8 px-4 sm:px-6 bg-white dark:bg-slate-950 transition-colors duration-300">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">© 2025 App Finanças. Todos os direitos reservados.</p>
